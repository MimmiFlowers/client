            ...
            <div className="mx-auto w-[92%] py-16 md:w-[88%] md:py-24">
                ...
                <div className="grid gap-10 md:grid-cols-12 md:gap-12">
                    <div className="md:col-span-6">
                        <p className="text-[0.82rem] tracking-[0.34em] uppercase text-[var(--color-blush)]">
                            From our atelier
                        </p>
                    ...
                    <div className="md:col-span-3 md:col-start-8">
                        <p className="text-[0.8rem] tracking-[0.32em] uppercase text-[var(--color-cream)]/55">
                ...
                {/* Bottom bar */}
                <div className="mt-8 flex flex-col items-center justify-between gap-3 text-[0.82rem] tracking-[0.18em] uppercase text-[var(--color-cream)]/45 sm:flex-row">
