    ...
    return (
        <footer className="mt-24 w-full bg-[var(--color-burgundy-deep)] text-[var(--color-bg)] relative">
            ...
            <div className="px-5 sm:px-8 lg:px-12 pt-16 pb-8 text-center">
                <span className="ornament block text-base text-[var(--color-gold-light)] mb-4 flicker">
                    ✦ ✦ ✦
                </span>
            ...
            <div className="px-5 sm:px-8 lg:px-12 py-14">
                <div className="grid grid-cols-1 gap-12 sm:grid-cols-3 max-w-5xl mx-auto">
                    ...
                    <div className="text-center sm:text-left">
                        <h3 className="eyebrow text-[var(--color-gold-light)]">— Maison</h3>
                        <p className="mt-4 text-[var(--color-bg)] text-base leading-relaxed font-display italic">
                            {t("footer.tagline")}
                        </p>
                    ...
                    {/* Quick links */}
                    <div className="text-center sm:text-left">
                        <h3 className="eyebrow text-[var(--color-gold-light)]">
                    ...
                    <div className="text-center sm:text-left">
                        ...
                        <div className="mt-4 flex flex-col gap-2 text-[var(--color-bg)] text-base">
                ...
                <div className="mt-16 pt-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-center">
                        ...
                        <Link to="/Privacy" className="eyebrow text-[var(--color-gold-light)] hover:text-[var(--color-bg)] transition-colors duration-300">
