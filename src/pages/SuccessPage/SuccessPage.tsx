    ...
    if (state === "loading") {
        return (
            <div className="flex min-h-[60vh] flex-col items-center justify-center px-4">
                ...
                <div className="mb-6 h-12 w-12 animate-spin rounded-full border-[3px] border-[var(--color-line)] border-t-[var(--color-leaf)]" />
                <p className="text-sm font-light tracking-wider text-[var(--color-fg-soft)] uppercase">
                    {t("success.verifying")}
                </p>
            </div>
        );
        ...
        return (
            <div className="flex min-h-[60vh] flex-col items-center justify-center px-4">
                ...
                <div className="mx-auto w-full max-w-md text-center">
                    ...
                    <p className="mb-8 text-sm leading-relaxed text-[var(--color-fg-soft)]">
