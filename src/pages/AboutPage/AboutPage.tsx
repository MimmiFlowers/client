        ...
        <div className="px-4 py-12">
            ...
            <div className="mx-auto w-[95%] max-w-5xl sm:w-[90%] md:w-[85%] lg:w-[80%]">
                ...
                <div className="mt-12 text-center">
                    <Link
                        to="/Catalog"
                        className="inline-block rounded-full bg-[var(--color-obsidian)] px-10 py-3 text-sm font-medium tracking-wider text-white uppercase transition-opacity duration-300 hover:opacity-80"
                    >
