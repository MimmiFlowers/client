    ...
    return (
        <div className="flex min-h-[60vh] flex-col items-center justify-center px-4">
            ...
            <div className="mx-auto w-full max-w-md text-center">
                {/* Large 404 */}
                <h1 className="mb-2 text-[7rem] leading-none font-extralight tracking-wider text-[var(--color-rose)]">
                    404
                </h1>

                <h2 className="mb-3 text-xl font-semibold text-[var(--color-burgundy)]">
                    {t("not_found.title")}
                </h2>
