    ...
    return (
        <div className="px-4 py-12">
            ...
            <div className="mx-auto w-[95%] max-w-3xl sm:w-[90%] md:w-[70%] lg:w-[60%]">
                {/* Header */}
                <h1 className="mb-2 text-3xl font-light tracking-wide text-[var(--color-obsidian)] sm:text-4xl">
                    {t("privacy.title")}
                </h1>
                ...
                <section className="mb-10">
                    <h2 className="mb-4 text-lg font-medium text-[var(--color-obsidian)]">
                ...
                <section className="mb-10">
                    ...
                    <p className="text-sm leading-relaxed text-[var(--color-fg-soft)]">
                        ...
                        <a
                            ...
                            className="text-[var(--color-obsidian)] underline underline-offset-2 transition-colors duration-300 hover:text-[var(--color-accent)]"
                        >
