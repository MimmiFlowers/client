    ...
    return (
        <div>
            ...
            <input
                ...
                disabled={disabled}
                min={min}
                className={`w-full rounded-lg border bg-white px-4 py-2.5 text-sm text-[var(--color-burgundy)] transition-all duration-200 outline-none placeholder:text-gray-300 disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-[var(--color-muted)] ${
                    error
                        ? "border-red-300 focus:border-red-400 focus:ring-2 focus:ring-red-100"
                        : "border-[var(--color-line)] focus:border-[var(--color-gold)] focus:ring-2 focus:ring-[#edc7f5]/30"
                }`}
                placeholder={label}
            />
            {error && (
        ...
        <label className="flex cursor-pointer items-center gap-3">
            <button
                ...
                className={`relative inline-flex h-5 w-9 shrink-0 cursor-pointer rounded-full transition-colors duration-200 ${
                    checked ? "bg-[var(--color-rose)]" : "bg-[var(--color-line)]"
                }`}
            >
                <span
...
function SectionHeader({ step, title }: { step: number; title: string }) {
    return (
        <div className="mb-5 flex items-center gap-3">
            <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[var(--color-rose)]/40 text-xs font-semibold text-[var(--color-fg-soft)]">
                {step}
            </span>
            <h2 className="text-base font-semibold tracking-wide text-[var(--color-burgundy)] uppercase">
                {title}
            </h2>
        </div>
    );
...
export default function CheckoutPage() {
    ...
    if (items.length === 0) {
        return (
            <div className="flex min-h-[60vh] flex-col items-center justify-center px-4">
                ...
                <Link
                    to="/Catalog"
                    className="rounded-full bg-[var(--color-burgundy)] px-8 py-2.5 text-sm font-medium tracking-wider text-white uppercase transition-opacity duration-300 hover:opacity-80"
                >
    ...
    return (
        <div className="mx-auto w-[95%] py-8 sm:w-[90%] md:w-[85%] lg:w-[80%]">
            ...
            {/* Page title */}
            <h1 className="mb-8 text-center text-xl font-light tracking-[0.15em] text-[var(--color-burgundy)] uppercase sm:text-2xl">
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-5">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full rounded-lg border bg-white px-4 py-2.5 text-sm text-[var(--color-burgundy)] transition-all duration-200 outline-none ${
                ...
                <aside className="lg:col-span-2">
                    <div className="sticky top-20 rounded-2xl bg-white/70 p-6 backdrop-blur-sm sm:p-8">
                        <h2 className="mb-5 text-base font-semibold tracking-wide text-[var(--color-burgundy)] uppercase">
                                ...
                                <div key={item.id} className="flex gap-3">
                                    ...
                                    <div className="flex min-w-0 flex-1 flex-col justify-between">
                                        <div className="flex items-start justify-between gap-2">
                                            <p className="truncate text-sm font-medium text-[var(--color-burgundy)]">
                                                {item.name}
                                            </p>
                                            <button
                                                onClick={() =>
                        ...
                        <div className="mt-6 space-y-2 border-t border-gray-100 pt-5">
                            ...
                            <div className="flex justify-between border-t border-gray-100 pt-3 text-base font-semibold text-[var(--color-burgundy)]">
                        ...
                        {/* Pay button */}
                        <button
                            className="mt-6 flex w-full cursor-pointer items-center justify-center gap-2 rounded-full bg-[var(--color-burgundy)] py-3.5 text-sm font-medium tracking-wider text-white uppercase transition-opacity duration-300 hover:opacity-80 disabled:cursor-not-allowed disabled:opacity-40"
                            onClick={handlePay}
