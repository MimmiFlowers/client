                            ...
                            <div className="rounded-2xl bg-white/70 p-6 backdrop-blur-sm">
                                ...
                                <div className="flex items-center gap-4">
                                    <a
                                        ...
                                        className="flex h-10 w-10 items-center justify-center rounded-full bg-[var(--color-accent)]/30 text-gray-500 transition-all duration-300 hover:bg-[var(--color-accent)]/50 hover:text-gray-800"
                                    >
                                        <svg
