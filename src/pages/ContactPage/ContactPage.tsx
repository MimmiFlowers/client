        ...
        <div className="px-4 py-12">
            ...
            <div className="mx-auto w-[95%] sm:w-[90%] md:w-[85%] lg:w-[80%] max-w-5xl">
                ...
                <div className="mb-12 text-center">
                    <h1 className="mb-3 text-3xl font-light tracking-wide text-[var(--color-obsidian)] sm:text-4xl">
                        {t("contact.title")}
                    </h1>
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[var(--color-accent)]/30">
                                    <svg
                                        className="h-4.5 w-4.5 text-[var(--color-fg-soft)] transition-colors duration-300 group-hover:text-[var(--color-obsidian)]"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        stroke="currentColor"
                                        strokeWidth={1.5}
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-sm font-light text-[var(--color-fg-soft)] transition-colors duration-300 group-hover:text-[var(--color-obsidian)]">
                            ...
                            <div className="rounded-2xl bg-white/70 p-6 backdrop-blur-sm">
                                ...
                                <div className="flex items-center gap-4">
                                    <a
                                        ...
                                        className="flex h-10 w-10 items-center justify-center rounded-full bg-[var(--color-accent)]/30 text-[var(--color-muted)] transition-all duration-300 hover:bg-[var(--color-accent)]/50 hover:text-gray-800"
                                    >
                                        <svg
