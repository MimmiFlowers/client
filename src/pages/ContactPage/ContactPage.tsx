                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            ...
                            <a
                                ...
                                className="group flex items-start gap-4 rounded-2xl bg-[var(--color-surface)]/70 p-5 backdrop-blur-sm transition-all duration-300 hover:bg-[var(--color-surface)]/90 hover:shadow-sm"
                            >
                                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[var(--color-leaf)]/30">
                                    <svg
                                        className="h-4.5 w-4.5 text-[var(--color-fg-soft)] transition-colors duration-300 group-hover:text-[var(--color-fg)]"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        stroke="currentColor"
                                        strokeWidth={1.5}
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-sm font-light text-[var(--color-fg)] transition-colors duration-300 group-hover:text-[var(--color-fg)]">
                            ...
                            {/* Hours card */}
                            <div className="flex items-start gap-4 rounded-2xl bg-[var(--color-surface)]/70 p-5 backdrop-blur-sm">
                                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[var(--color-leaf)]/30">
                                    <svg
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-sm font-light text-[var(--color-fg)]">
                    ...
                    <div className="space-y-8">
                        ...
                        <div>
                            ...
                            <div className="rounded-2xl bg-[var(--color-surface)]/70 p-6 backdrop-blur-sm">
                                <p className="mb-5 text-sm font-light leading-relaxed text-[var(--color-fg-soft)]">
                                ...
                                <div className="flex items-center gap-4">
                                    <a
                                        ...
                                        className="flex h-10 w-10 items-center justify-center rounded-full bg-[var(--color-leaf)]/30 text-[var(--color-fg-soft)] transition-all duration-300 hover:bg-[var(--color-leaf)]/50 hover:text-[var(--color-fg)]"
                                    >
                                        <svg
