                        ...
                        <nav className="mt-20 flex flex-col px-8">
                            {navLinks.map((link, i) => (
                                <Link
                                    ...
                                    to={link.to}
                                    onClick={closeMenu}
                                    className={`group flex items-center py-3 text-sm font-light tracking-[0.15em] text-[var(--color-fg)] uppercase transition-colors duration-300 hover:text-[var(--color-ink)] ${
                                        i < navLinks.length - 1
                                            ? "border-b border-[var(--color-line)]/60"
                                            : ""
                                    }`}
                                >
                                    <span className="mr-0 w-0 overflow-hidden text-[var(--color-leaf)] transition-all duration-300 group-hover:mr-2 group-hover:w-3">
                                        &rsaquo;
                                    </span>
                                    {link.label}
                                </Link>
                        ...
                        <div className="mt-auto border-t border-[var(--color-line)]/60 p-6">
                            ...
                            <div className="mt-4 flex items-center justify-center gap-5 md:mt-0">
                                <a
                                    ...
                                    className="text-[var(--color-muted)] transition-colors duration-300 hover:text-[var(--color-fg)]"
                                >
                                    <svg
