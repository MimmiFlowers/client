        ...
        <div className="flex flex-col">
            ...
            <div className="mb-5 flex items-center justify-between">
                ...
                {hasFilters && (
                    <button
                        onClick={onClearAll}
                        className="cursor-pointer text-sm text-[var(--color-muted)] underline transition-colors hover:text-black"
                    >
                        {t("catalog.clear_all")}
                    </button>
                )}
            ...
            <div className="mb-6">
                ...
                <select
                    ...
                    className="w-full cursor-pointer rounded-lg border border-[var(--color-hairline)] bg-white px-3 py-2.5 text-sm text-[var(--color-fg-soft)] outline-none transition-colors focus:border-[var(--color-gold)]"
                >
            ...
            <div className="py-5">
                ...
                >
                    <h3 className="text-sm font-semibold uppercase tracking-wider text-[var(--color-fg-soft)]">
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex cursor-pointer items-center gap-2.5 rounded-lg px-3 py-2 text-left text-sm transition-all duration-200 ${
                                        active
                                            ? "bg-[var(--color-rose)]/30 font-medium text-[var(--color-burgundy)]"
                                ...
                                >
                                    <span
                                        className={`flex h-4 w-4 flex-shrink-0 items-center justify-center rounded border transition-colors ${
                                            active
                                                ? "border-[var(--color-gold)] bg-[var(--color-rose)]"
