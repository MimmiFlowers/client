        ...
        <div className="flex flex-col">
            ...
            <div className="mb-6">
                ...
                <select
                    ...
                    className="w-full cursor-pointer rounded-lg border border-gray-300 bg-white px-3 py-2.5 text-sm text-gray-700 outline-none transition-colors focus:border-[var(--color-leaf)]"
                >
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex cursor-pointer items-center gap-2.5 rounded-lg px-3 py-2 text-left text-sm transition-all duration-200 ${
                                        active
                                            ? "bg-[var(--color-leaf)]/30 font-medium text-gray-900"
