            ...
            <div className="mt-4 flex max-h-64 flex-col gap-3 overflow-y-auto">
                {items.length === 0 ? (
                    <div className="flex flex-col items-center py-6">
                        <svg
                            className="mb-2 h-10 w-10 text-[var(--color-muted)]"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                            strokeWidth={1}
                        ...
                        >
                            ...
                            <div className="flex-1">
                                <p
                                    ...
                                    role="button"
                                    tabIndex={0}
                                    className="cursor-pointer text-sm font-medium leading-tight text-[var(--color-fg)] transition-opacity duration-300 hover:opacity-70"
                                >
                                    {item.name}
                                </p>
                ...
                <>
                    <div className="mt-3 space-y-1.5 border-t border-[var(--color-line)]/60 pt-3">
                        ...
                        <div className="flex justify-between border-t border-[var(--color-line)]/60 pt-2">
                            <span className="text-sm font-medium uppercase tracking-wider text-[var(--color-fg-soft)]">
                                {t("cart.total")}
                            </span>
