    ...
    return (
        ...
        >
            ...
            <div className="absolute right-7 bottom-7 left-7 text-[var(--color-cream)]">
                <p className="text-[0.65rem] tracking-[0.34em] uppercase text-[var(--color-cream)]/75 italic">
                    A composition of
                </p>
                ...
                <div className="mt-4 flex items-center gap-3">
                    ...
                    <span className="text-[0.7rem] tracking-[0.26em] uppercase text-[var(--color-blush)]">
                        Explore
                    </span>
                </div>
            </div>
